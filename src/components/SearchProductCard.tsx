...
export default function SearchProductCard({ image, title, description,
     price, rating, discount, stock } : SProductDetails) {
    return (
        <>
            <section className="bg-white  rounded-sm py-3 px-2 hover:shadow-md
                    ...
                    <div className="basis-[70%] px-3">
                        ...
                        <div className="flex flex-col md:flex-row justify-between md:items-center ">
                            ...
                            <div className="flex items-center gap-4">
                                {
                                    discount &&(
                                    <p className="font-bold text-base text-black lg:text-lg">{getCurrencySign(getDiscountPrice(price, discount))}</p>
                                    )
                                }
                                
                                <p className={`font-bold text-base text-black lg:text-lg ${clsx({'line-through font-normal text-slate-400': discount})}`}>{getCurrencySign(price * 100)}</p>
                            </div>    
                        </div>
                        <div className="mt-2">
